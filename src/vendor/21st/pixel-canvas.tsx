/*
 * RAW, UNMODIFIED pull from 21st.dev (serafimcloud/pixel-canvas).
 * Not wired into the app. Reference only — see /goal for adaptation plan.
 * Source: https://21st.dev/@serafimcloud/components/pixel-canvas
 */
"use client"
...
const PixelCanvas = React.forwardRef<HTMLDivElement, PixelCanvasProps>(
  ({ gap, speed, colors, variant, noFocus, style, ...props }, ref) => {
    React.useEffect(() => {
      // Register the web component on first render
