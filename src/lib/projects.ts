...
export const projects: Project[] = [
  {
    ...
    problem:
      'Reliable first line health information is hard to reach. Search results overwhelm you and appointments take days.',
    outcome:
  ...
  },
  {
    ...
    problem: 'Manual review of fire and smoke life test footage is slow and easy to get wrong.',
    outcome:
  ...
  },
  {
    ...
    problem: 'During a fire, knowing whether a person is actually inside the danger zone is a time critical, life safety judgment call.',
    outcome:
      'A custom trained YOLO11 model that detects fire, smoke and people in a live video feed and fires an evacuation alert on screen, in the logs and by email the moment a person overlaps an active flame.',
  ...
  },
  {
    ...
    outcome:
      'A free music streaming web app with search, playlists and uninterrupted playback, no ads and no accounts.',
  ...
  },
  {
    ...
    track: 'web',
    year: '2023',
    tagline: 'An ecommerce front end, pixel by pixel.',
    problem: 'Fashion ecommerce lives or dies on presentation and browsing flow.',
    outcome:
      'A storefront front end I built by hand, with product grids, detail views and a cart flow in vanilla HTML, CSS and JS.',
  ...
  },
  {
    ...
    problem: 'Game loops, collision and state. The fundamentals, worth doing by hand.',
